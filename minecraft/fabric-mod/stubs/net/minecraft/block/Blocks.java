...
public class Blocks {
    ...
    public static final Block GRASS_BLOCK = new Block();
    public static final Block DIRT = new Block();
    public static final Block MOSS_BLOCK = new Block();
    public static final Block BLUE_ICE = new Block();
    public static final Block SLIME_BLOCK = new Block();
    public static final Block MOSSY_COBBLESTONE = new Block();
    ...
    public static final Block WHEAT = new Block();
    public static final Block TORCH = new Block();
    public static final Block POWERED_RAIL = new Block();
    public static final Block RAIL = new Block();
    public static final Block CUT_SANDSTONE = new Block();
    public static final Block BASALT = new Block();
    public static final Block OBSIDIAN = new Block();
    public static final Block ICE = new Block();
    public static final Block SPRUCE_PLANKS = new Block();
    public static final Block DARK_OAK_PLANKS = new Block();
    public static final Block SMOOTH_SANDSTONE = new Block();
    public static final Block BROWN_TERRACOTTA = new Block();
    public static final Block POLISHED_DEEPSLATE = new Block();

...
public class SpiderCoreItem extends Item {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        Entity mob = ModEntities.MECHA_SPIDER.create(serverWorld, SpawnReason.EVENT);
        if (mob == null) {
            return ActionResult.SUCCESS;
        }
        ...
        serverWorld.playSound(null, user.getBlockPos(), SoundEvents.ENTITY_WITHER_SPAWN,
                SoundCategory.HOSTILE, 8.0F, 1.3F);
        user.sendMessage(Text.literal("§8⌬ Six legs, and all of them working."), false);

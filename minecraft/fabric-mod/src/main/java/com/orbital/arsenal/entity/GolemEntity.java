...
/** Slow, enormously tough, and hits like the stone it is made of. */
public class GolemEntity extends HostileEntity {
    public GolemEntity(EntityType<? extends HostileEntity> type, World world) {
        super(type, world);
    }

    public static DefaultAttributeContainer.Builder createGolemAttributes() {
        return HostileEntity.createHostileAttributes()
                .add(EntityAttributes.MAX_HEALTH, 520.0)
                .add(EntityAttributes.MOVEMENT_SPEED, 0.20)
                .add(EntityAttributes.ATTACK_DAMAGE, 16.0)
                .add(EntityAttributes.FOLLOW_RANGE, 44.0)
